...
import Customernotelists from './Customernotelists';
        ...
        <div className="flex flex-col w-full gap-4 animate-in fade-in duration-500">
            <div className="bg-white rounded-md border border-slate-200 shadow-sm overflow-hidden transition-all duration-300 hover:shadow-md">
                <div className="bg-slate-50/80 px-4 py-3 border-b border-slate-200 flex items-center gap-2">
                    ...
                    <h3 className="text-sm font-semibold text-slate-800 uppercase tracking-tight">Add Customer Note</h3>
                </div>

                <div className="p-4 flex flex-col gap-3">
                    <div className="relative">
                        <Textarea
                            placeholder="Type your customer notes, feedback, or follow-up details here..."
                            value={noteMessage}
                            onChange={updateNote}
                    ...
                    <div className="flex justify-between items-center pt-2">
                        ...
                        {permissions?.customers_page?.includes("add_notes_single_customer") && (
                            <Button
                                onClick={submitNote}
            ...
            <div className="flex flex-col w-full gap-4">
                ...
                <div className="flex w-full">
                    <Customernotelists refreshKey={refreshKey} />
                </div>
            </div>
        </div>
    );
