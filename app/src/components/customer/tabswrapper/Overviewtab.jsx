...
function Overviewtab({ customerFlatDetails, paymentsList }) {
        ...
        <div className="w-full bg-white rounded-lg border border-gray-200 mt-4 overflow-x-auto text-sm">
            <div className="min-w-[800px]">
                ...
                <div className="grid grid-cols-12 border-b border-gray-200 hover:bg-gray-50">
                    <div className="col-span-4 p-3 border-r border-gray-200 font-medium text-gray-800">Super Built-up Area (sq.ft)</div>
                ...
                <div className="grid grid-cols-12 border-b border-gray-200 hover:bg-gray-50">
                    <div className="col-span-4 p-3 border-r border-gray-200 font-medium text-gray-800">Basic Rate (per sq.ft)</div>
                ...
                <div className="grid grid-cols-12 border-b border-gray-200 bg-yellow-50/50 hover:bg-yellow-50">
                    <div className="col-span-4 p-3 border-r border-gray-200 font-medium text-red-600">Discounted Basic Rate (per sq.ft)</div>
                ...
                <div className="grid grid-cols-12 border-b-2 border-gray-300 bg-gray-50">
                    <div className="col-span-4 p-3 border-r border-gray-200 font-bold text-gray-900">Base Price (Cost of Unit)</div>
