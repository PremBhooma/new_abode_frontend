...
function Overviewtab({ customerFlatDetails, paymentSummary }) {
    ...
    console.log("Customers_paymentSummary:", paymentSummary);
    ...
    // Extract the correct summary data if the backend returned an array
    const summaryData = Array.isArray(paymentSummary) ? paymentSummary[0] : paymentSummary;

    // Calculate total amount paid from the provided payment summary mapping
    const totalAmountPaid = summaryData ? Object.values(summaryData).reduce((sum, item) => sum + (Number(item?.paid) || 0), 0) : 0;

    return (
        <div className="w-full bg-white rounded-lg border border-gray-200 mt-4 overflow-x-auto text-sm">
            <div className="min-w-[900px]">
                {/* Table Header */}
                <div className="grid grid-cols-12 bg-[#fde047] border-b border-gray-200 font-bold text-gray-700">
                    <div className="col-span-3 p-3 border-r border-gray-200">Description</div>
                ...
                <div className="grid grid-cols-12 border-b border-gray-200 hover:bg-gray-50">
                    <div className="col-span-3 p-3 border-r border-gray-200 font-medium text-gray-800">Saleable Area (sq.ft)</div>
                ...
                <div className="grid grid-cols-12 border-b border-gray-200 bg-yellow-50/50 hover:bg-yellow-50">
                    <div className="col-span-3 p-3 border-r border-gray-200 font-medium text-red-600">Rate Per Sq.ft (₹)</div>
                ...
                <div className="grid grid-cols-12 border-b border-gray-200 hover:bg-gray-50">
                    <div className="col-span-3 p-3 border-r border-gray-200 font-medium text-gray-800">Base Cost of Unit (₹)</div>
                ...
                {Number(totalFloorRiseCost) > 0 && (
                    <div className="grid grid-cols-12 border-b border-gray-200 hover:bg-gray-50">
                        <div className="col-span-3 p-3 border-r border-gray-200 font-medium text-gray-800">Floor Rise Charges (₹ {floorRise} per sq.ft)</div>
                ...
                {Number(totalCornerCost) > 0 && (
                    <div className="grid grid-cols-12 border-b border-gray-200 hover:bg-gray-50">
                        <div className="col-span-3 p-3 border-r border-gray-200 font-medium text-gray-800">Corner Facing Premium (₹ {corner} per sq.ft)</div>
                ...
                {Number(totalEastFacingCost) > 0 && (
                    <div className="grid grid-cols-12 border-b border-gray-200 hover:bg-gray-50">
                        <div className="col-span-3 p-3 border-r border-gray-200 font-medium text-gray-800">East Facing Premium (₹ {eastFacing} per sq.ft)</div>
                ...
                <div className="grid grid-cols-12 border-b border-gray-200 hover:bg-gray-50">
                    <div className="col-span-3 p-3 border-r border-gray-200 font-medium text-gray-800">Amenities Charges</div>
                ...
                <div className="grid grid-cols-12 border-b-2 border-gray-300 bg-gray-50">
                    <div className="col-span-3 p-3 border-r border-gray-200 font-bold text-gray-900">Total Cost of Unit</div>
                ...
                <div className="grid grid-cols-12 border-b border-gray-200 hover:bg-gray-50 mt-1">
                    ...
                    <div className="col-span-2 p-3 text-right border-r border-gray-200 text-green-600 font-semibold bg-green-50/30">
                        {formatPrice(summaryData?.gst?.paid)}
                    </div>
                    <div className="col-span-2 p-3 text-right text-orange-600 font-semibold bg-orange-50/30">
                        {formatPrice(summaryData?.gst?.remaining)}
                    </div>
                </div>

                <div className="grid grid-cols-12 border-b-2 border-gray-300 bg-gray-50 hover:bg-gray-100">
                    <div className="col-span-3 p-3 border-r border-gray-200 font-bold text-gray-900">Cost of Unit with Tax</div>
                    <div className="col-span-2 p-3 text-right border-r border-gray-200 text-gray-600"></div>
                ...
                {/* Other Fees */}
                <div className="grid grid-cols-12 border-b border-gray-200 hover:bg-gray-50">
                    <div className="col-span-3 p-3 border-r border-gray-200 font-medium text-gray-800">Corpus Fund</div>
                    <div className="col-span-2 p-3 text-right border-r border-gray-200 text-gray-600"></div>
                    <div className="col-span-3 p-3 text-right border-r border-gray-200 font-medium text-gray-800">{formatPrice(corpusFund)}</div>
                    <div className="col-span-2 p-3 text-right border-r border-gray-200 text-green-600 font-semibold bg-green-50/30">
                        {formatPrice(summaryData?.corpusFund?.paid)}
                    </div>
                    <div className="col-span-2 p-3 text-right text-orange-600 font-semibold bg-orange-50/30">
                        {formatPrice(summaryData?.corpusFund?.remaining)}
                    </div>
                </div>

                <div className="grid grid-cols-12 border-b border-gray-200 hover:bg-gray-50">
                    <div className="col-span-3 p-3 border-r border-gray-200 font-medium text-gray-800">Maintenance Charges</div>
                    <div className="col-span-2 p-3 text-right border-r border-gray-200 text-gray-600"></div>
                    ...
                    <div className="col-span-2 p-3 text-right border-r border-gray-200 text-green-600 font-semibold bg-green-50/30">
                        {formatPrice(summaryData?.maintenanceCharges?.paid)}
                    </div>
                    <div className="col-span-2 p-3 text-right text-orange-600 font-semibold bg-orange-50/30">
                        {formatPrice(summaryData?.maintenanceCharges?.remaining)}
                    </div>
                </div>

                <div className="grid grid-cols-12 border-b border-gray-200 hover:bg-gray-50">
                    <div className="col-span-3 p-3 border-r border-gray-200 font-medium text-gray-800">Documentation Fee</div>
                    <div className="col-span-2 p-3 text-right border-r border-gray-200 text-gray-600"></div>
                    ...
                    <div className="col-span-2 p-3 text-right border-r border-gray-200 text-green-600 font-semibold bg-green-50/30">
                        {formatPrice(summaryData?.documentationFee?.paid)}
                    </div>
                    <div className="col-span-2 p-3 text-right text-orange-600 font-semibold bg-orange-50/30">
                        {formatPrice(summaryData?.documentationFee?.remaining)}
                    </div>
                </div>

                <div className="grid grid-cols-12 border-b border-gray-200 hover:bg-gray-50 mt-1">
                    <div className="col-span-3 p-3 border-r border-gray-200 font-medium text-gray-800">Manjeera Connection Charge</div>
                    <div className="col-span-2 p-3 text-right border-r border-gray-200 text-gray-600"></div>
                    ...
                    <div className="col-span-2 p-3 text-right border-r border-gray-200 text-green-600 font-semibold bg-green-50/30">
                        {formatPrice(summaryData?.manjeeraConnectionCharge?.paid)}
                    </div>
                    <div className="col-span-2 p-3 text-right text-orange-600 font-semibold bg-orange-50/30">
                        {formatPrice(summaryData?.manjeeraConnectionCharge?.remaining)}
                    </div>
                </div>

                <div className="grid grid-cols-12 border-b border-gray-200 hover:bg-gray-50 mt-1">
                    <div className="col-span-3 p-3 border-r border-gray-200 font-medium text-gray-800">Manjeera Meter Connection</div>
                    <div className="col-span-2 p-3 text-right border-r border-gray-200 text-gray-600"></div>
                    ...
                    <div className="col-span-2 p-3 text-right border-r border-gray-200 text-green-600 font-semibold bg-green-50/30">
                        {formatPrice(summaryData?.manjeeraMeterCharge?.paid)}
                    </div>
                    <div className="col-span-2 p-3 text-right text-orange-600 font-semibold bg-orange-50/30">
                        {formatPrice(summaryData?.manjeeraMeterCharge?.remaining)}
                    </div>
                </div>

                <div className="grid grid-cols-12 border-b border-gray-200 hover:bg-gray-50 mt-1">
                    <div className="col-span-3 p-3 border-r border-gray-200 font-medium text-gray-800">Registration</div>
                    <div className="col-span-2 p-3 text-right border-r border-gray-200 text-gray-600"></div>
                    <div className="col-span-3 p-3 text-right border-r border-gray-200 font-medium text-gray-800">{formatPrice(registrationCharge)}</div>
                    <div className="col-span-2 p-3 text-right border-r border-gray-200 text-green-600 font-semibold bg-green-50/30">
                        {formatPrice(summaryData?.registration?.paid)}
                    </div>
                    <div className="col-span-2 p-3 text-right text-orange-600 font-semibold bg-orange-50/30">
                        {formatPrice(summaryData?.registration?.remaining)}
                    </div>
                </div>

                {/* Grand Total */}
                <div className="grid grid-cols-12 bg-[#fde047] border-t-2 border-gray-400">
                    <div className="col-span-5 p-4 border-r border-gray-300 font-bold text-gray-900 text-base uppercase">Grand Total</div>
