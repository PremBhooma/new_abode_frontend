...
function Toolbarwrapper({ refreshFolderDeatils, currentFolderUuid, currentFolderId, folderPath, id }) {
        ...
        <>
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                ...
                <div className="flex items-center gap-2.5">
                    ...
                    {permissions?.customers_page?.includes("add_folder_in_document_in_customer") && (
                        <button
                    ...
                    {permissions?.customers_page?.includes("upload_file_in_customer") && (
                        <button
