...
function Updateactivities({ customerflat_id }) {
    ...
    const getUpdateactivities = async (loadMore = false) => {
    ...
    return (
        taskActvities?.length > 0 && (
            <div className="flex flex-col h-[calc(100vh-440px)] overflow-y-auto">
