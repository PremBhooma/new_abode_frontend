                                ...
                                >
                                    ...
                                    <div className="relative flex flex-col items-center">
                                        <div className="z-10 w-8 h-8 rounded-full bg-white border border-gray-200 shadow-sm flex items-center justify-center transition-transform group-hover:scale-110">
                                            {getActivityIcon(activity.ta_message)}
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex-1 pt-0.5 pb-2">
                                        <div className="flex flex-col gap-1.5">
                                            <p className="text-[14px] text-left leading-relaxed text-gray-700">
                                                ...
                                                {(activity.ta_message || "").split(" ").map((word, i) => {
                                                    const isSpecial =
                                                        word.startsWith("A1") ||
                                                        word.includes("Smart") ||
                                                        (activity.employee_name &&
                                                            activity.employee_name.includes(word));
                                                    return (
                                                        <span
                                                            key={i}
                                                            className={
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="flex items-center gap-1.5">
                                                    ...
                                                    <NavLink
                                                        to={`/single-employee-view/${activity.employee_id}`}
                                                        className="text-[11px] text-gray-500 font-semibold hover:text-[#0083bf] transition-colors"
                                                    >
                                                        {activity.employee_name}
                                                    </NavLink>
                                                </div>
                                            ...
                                            {activity.ta_message?.toLowerCase().includes("call") && (
