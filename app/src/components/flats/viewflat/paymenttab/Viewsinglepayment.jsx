...
function Viewsinglepayment({ flatPaymentUUID, closeViewFlatPayment }) {
        ...
        <>
            <div className="flex flex-col gap-4 w-full px-6 py-4">
                <div className="flex justify-between items-center">
                    <h1 className="text-gray-800 text-lg font-semibold max-sm:text-xl">Flat Payment Details</h1>
                    <div onClick={closeViewFlatPayment} className="cursor-pointer py-1 px-2 rounded-sm !bg-red-500 text-white font-semibold">
                        Close
                    </div>
                </div>
